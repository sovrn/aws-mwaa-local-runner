...
JOB_FLOW_OVERRIDES = {
    ...
    'Instances': {
        ...
        'Ec2SubnetId': 'subnet-059922bede17aceac',
...
did_feed_creation_succeed = BranchPythonOperator(
    task_id='did_feed_creation_succeed',
    python_callable=check_task_status,
    provide_context=True,
    op_kwargs={
        'task_to_check': job_flow_creator,
        'downstream_task_if_success': 'emr_succeeded',
        'downstream_task_if_failure': 'emr_failed',
        'downstream_task_if_skipped': 'emr_skipped'
    },
...
emr_succeeded = DummyOperator(
    task_id='emr_succeeded'
)

emr_failed = DummyOperator(
    task_id='emr_failed'
)

emr_skipped = DummyOperator(
    task_id='emr_skipped'
)
...
commerce_health_check >> job_flow_creator >> step_adder_3pid >> step_adder_superset >> step_checker_3pid >>step_checker_superset >> did_feed_creation_succeed >> [emr_succeeded, emr_failed, emr_skipped] >> cluster_remover
